...
const CardMovie = () => {
  ...
  return (
    ...
    <Grid container={true} spacing={6}>
        ...
        <CardContent>
          <img alt="" src={`https://image.tmdb.org/t/p/original/${row.poster_path}`} style={{ height: '100%', width: '100%' }} />
        </CardContent>
        <CardContent>
        ...
        <CardActions className="card-action-dense">
          ...
          >
            ...
            <Link color="primary" href={`/movies/${row.id}`} underline="none">Details</Link>
